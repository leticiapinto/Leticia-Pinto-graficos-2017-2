...
namespace graphics
{
    ...
    ShaderManager::ShaderManager()
    {
        ...
        _vShader = createShader( "../res/shaders/terrainshader_vs.glsl", GL_VERTEX_SHADER );
        _fShader = createShader( "../res/shaders/terrainshader_fs.glsl", GL_FRAGMENT_SHADER );
        _program = createProgram( _vShader, _fShader );

        programs["terrainshader"] = _program;


        _vShader = createShader( "../res/shaders/cubemap_vs.glsl", GL_VERTEX_SHADER );
        _fShader = createShader( "../res/shaders/cubemap_fs.glsl", GL_FRAGMENT_SHADER );
        _program = createProgram( _vShader, _fShader );

        programs["cubemapshader"] = _program;


        _vShader = createShader( "../res/shaders/skybox_vs.glsl", GL_VERTEX_SHADER );
        _fShader = createShader( "../res/shaders/skybox_fs.glsl", GL_FRAGMENT_SHADER );
        _program = createProgram( _vShader, _fShader );

        programs["skyboxshader"] = _program;
